...
function triggerFinalHug() {
    ...
    // 1. Mostrar todo de golpe (Sin delay)
    document.getElementById("finalScreen").classList.remove("invisible");
    document.getElementById("achievement-layer").classList.remove("invisible");
    
    // 2. Disparar animación del stickers de abacho
    document.getElementById("abrazo").classList.add("animar-abrazo");
